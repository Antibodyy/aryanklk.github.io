...
My technical skillset spans across:
- **CAD & Design**: SolidWorks, Fusion 360, AutoCAD, KiCAD
- **Engineering Analysis**: ANSYS Workbench (Structural, Thermal, Harmonic, FEA), MATLAB, SIMULINK
- **Programming**: Python, C++, ROS2
- **Prototyping**: 3D Printing, Soldering, PCB Design, Design Validation

## Get in Touch

I'm always interested in discussing mechanical design, semiconductor manufacturing, and engineering automation. Feel free to reach out via [email](mailto:aryanklk@berkeley.edu) or connect with me on [LinkedIn](https://www.linkedin.com/in/aryan-klk).

You can also check out my [CV](/cv/) for more details about my experience and projects.
