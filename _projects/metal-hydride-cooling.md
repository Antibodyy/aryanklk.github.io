...
* **Achieved 18.8% reduction in AC load** compared to conventional cooling systems, directly improving vehicle range and energy efficiency for hydrogen fuel cell electric vehicles

## About This Project

This project developed an innovative cooling system for hydrogen fuel cell electric vehicles (FCEV) that solves high-density heat transfer challenges. By leveraging metal hydride thermal properties, the system reduces the parasitic power losses associated with traditional cooling while maintaining effective thermal management.
